...
{
	public partial class square : PositionedObject, IDestroyable
	{
        ...
        public square(string contentManagerName) :
            this(contentManagerName, true)
        {
        }


        public square(string contentManagerName, bool addToManagers) :
			base()
		{
			// Don't delete this:
		...
		public static void LoadStaticContent (string contentManagerName)
		{
			...
			if (LoadedContentManagers.Contains(contentManagerName) == false)
			{
				...
				lock (mLockObject)
				{
					...
					{
						FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("squareStaticUnload", UnloadStaticContent);
