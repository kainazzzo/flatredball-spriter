...
namespace spritertestgame
{
    ...
    public class MyTest
    {
        ...
        public void ToRuntimeTest()
        {
            ...
            Assert.AreEqual(0.0f, so.KeyFrameList[0].Values[pivot].Position.X, "RelativePosition Test");
            Assert.AreEqual(0.0f, so.KeyFrameList[0].Values[pivot].Position.Y, "RelativePosition Test");
            Assert.AreEqual(0.0f, so.KeyFrameList[0].Values[pivot].Position.Z, "RelativePosition Test");
            ...
            Assert.AreEqual(0.0f, so.KeyFrameList[1].Values[pivot].Position.X, "RelativePosition Test");
            Assert.AreEqual(128.0f, so.KeyFrameList[1].Values[pivot].Position.Y, "RelativePosition Test");
            Assert.AreEqual(0.0f, so.KeyFrameList[1].Values[pivot].Position.Z, "RelativePosition Test");
            ...
            Assert.AreEqual(-128.0f, so.KeyFrameList[2].Values[pivot].Position.X, "RelativePosition Test");
            Assert.AreEqual(128.0f, so.KeyFrameList[2].Values[pivot].Position.Y, "RelativePosition Test");
            Assert.AreEqual(0.0f, so.KeyFrameList[2].Values[pivot].Position.Z, "RelativePosition Test");
            ...
            Assert.AreEqual(-128.0f, so.KeyFrameList[3].Values[pivot].Position.X, "RelativePosition Test");
            Assert.AreEqual(0.0f, so.KeyFrameList[3].Values[pivot].Position.Y, "RelativePosition Test");
            Assert.AreEqual(0.0f, so.KeyFrameList[3].Values[pivot].Position.Z, "RelativePosition Test");
            ...
            Assert.AreEqual(0.0f, so.KeyFrameList[4].Values[pivot].Position.X, "RelativePosition Test");
            Assert.AreEqual(0.0f, so.KeyFrameList[4].Values[pivot].Position.Y, "RelativePosition Test");
            Assert.AreEqual(0.0f, so.KeyFrameList[4].Values[pivot].Position.Z, "RelativePosition Test");
